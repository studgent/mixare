...
public class ImageMarkerService extends Service{
    ...
    private final IMarkerService.Stub binder = new IMarkerService.Stub() {
		...
		@Override
		public double getBearing(String markerName) throws RemoteException {
			return markers.get(markerName).getBearing();
		}

		@Override
		public void setBearing(String markerName, double bearing) throws RemoteException {
			markers.get(markerName).setBearing(bearing);
